...
from django_rest_passwordreset.serializers import PhoneOrEmailSerializer, EmailSerializer, PasswordTokenSerializer, ResetPasswordSerializer
...
class ResetPasswordRequestToken(GenericAPIView):
    ...
    throttle_classes = ()
    permission_classes = ()
    serializer_class = PhoneOrEmailSerializer
...
reset_password_apiview = ResetPasswordApiView.as_view()
